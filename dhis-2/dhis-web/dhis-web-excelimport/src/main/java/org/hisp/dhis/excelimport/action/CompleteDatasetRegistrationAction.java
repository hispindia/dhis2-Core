...
public class CompleteDatasetRegistrationAction implements Action
{
    ...
    public String execute() throws Exception
    {
        ...
        periodList = new ArrayList<Period>( periodService.getPeriodsBetweenDates( periodType, sDate, eDate ) ); // add for 2.40.4
        //periodList = new ArrayList<Period>( periodService.getIntersectingPeriodsByPeriodType( periodType, sDate, eDate ) ); // comment in 2.40.4
