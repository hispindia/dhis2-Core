    ...
    */
    ...
    public String execute() throws Exception
    {
       ...
       // Collection<DataElement> dataElements = dataSet.getDataElements();
        ...
        List<CategoryOptionCombo> categoryOptionCombos = new ArrayList<CategoryOptionCombo>();
        ...
        {            
            for ( Period period : periodList )
            {
                ...
                for( CategoryOptionCombo dataElementCategoryOptionCombo : categoryOptionCombos )
                {
