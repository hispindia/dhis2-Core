        ...
        throws Exception
    {
        ...
        else
        {
            ...
            while ( ouIterator.hasNext() )
            {
                ...
                if ( organisationUnitService.getOrganisationUnitLevel( orgU.getId() ).getLevel() > orgUnitLevelCB )
                {
                    ouIterator.remove();
                }
            }
                ...
                for ( DataElement de : deList )
                {
                    ...
                    if ( ( dePeriodTypeMap.get( de ).equals( p.getPeriodType() )) )
                    {
                        ...
                        if ( ouSelCB != null )
                        {
                            ...
                            List<CategoryOptionCombo> decocList = new ArrayList<CategoryOptionCombo>( de.getCategoryCombo().getSortedOptionCombos() );
                            for ( CategoryOptionCombo decoc : decocList )
                            {
                        ...
                        else
                        {
                            ...
                            CategoryCombo dataElementCategoryCombo = de.getCategoryCombo();
                            ...
                            {
                                CategoryOptionCombo dataElementCategoryOptionCombo =  optionComboIterator.next();
        ...
        for ( int level = minOULevel; level < maxOuLevel; level++ )
        {
            ...
            {
                int levelOu = organisationUnitService.getOrganisationUnitLevel( ou.getId() ).getLevel();
                if ( levelOu == level )
                {
        ...
        Collections.sort( ouHavingNullValues );
