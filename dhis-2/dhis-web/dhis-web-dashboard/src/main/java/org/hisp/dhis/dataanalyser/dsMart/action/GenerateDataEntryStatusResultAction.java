    ...
    */
    ...
    public String execute() throws Exception
    {
        ...
        for ( DataElement de1 : dataElements )
        {
            ...
            totalDataElementCount += de1.getDataElementCategoryCombo().getOptionCombos().size();
        }
        ...
        while ( orgUnitListIterator.hasNext() )
        {
            ...
            if ( maxOULevel < organisationUnitService.getOrganisationUnitLevel( ou.getId() ).getLevel() )
                maxOULevel = organisationUnitService.getOrganisationUnitLevel( ou.getId() ).getLevel();

            if ( minOULevel > organisationUnitService.getOrganisationUnitLevel( ou.getId() ).getLevel() )
                minOULevel = organisationUnitService.getOrganisationUnitLevel( ou.getId() ).getLevel();
        }
