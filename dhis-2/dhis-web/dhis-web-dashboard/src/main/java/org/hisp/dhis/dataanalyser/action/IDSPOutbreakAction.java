...
//    }
        ...
        throws Exception
    {
        ...
        {
            UserCredentials userCredentials = userService.getUserCredentialsByUsername( currentUserService.getCurrentUser().getUsername() );
        ...
        if( normInfo != null && normInfo.size() > 0 )
        {
            ...
            if( drillDownOrgUnitId != null )
            {
                ...
                List<OrganisationUnit> orgUnitBrach = new ArrayList<OrganisationUnit>( getOrganisationUnitBranch( Integer.parseInt( drillDownOrgUnitId ) ) );
                int flag = 1;
