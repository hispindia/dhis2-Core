...
//    }
    ...
    */
        ...
        throws Exception
    {
        ...
        List<CategoryOptionCombo> optionComboList = new ArrayList<CategoryOptionCombo>();
        ...
        while ( optionComboIterator.hasNext() )
        {
            ...
            //DataElementCategoryOptionCombo dcoc = dataElementCategoryService.getDataElementCategoryOptionCombo( optionComboId );
            CategoryOptionCombo dcoc = categoryService.getCategoryOptionCombo( optionComboId );

            StringBuffer optionComboName = new StringBuffer();

            List<CategoryOption> categoryOptions = new ArrayList<CategoryOption>( dcoc.getCategoryOptions() );
        ...
        while ( dataElementListIterator.hasNext() )
        {
            ...
            Iterator<CategoryOptionCombo> optionComboListIterator = optionComboList.iterator();
            while ( optionComboListIterator.hasNext() )
            {
                CategoryOptionCombo decoc = (CategoryOptionCombo) optionComboListIterator.next();
