    ...
    function($rootScope,
        ...
        OrgUnitFactory.getOrgUnit(($location.search()).ou).then(function(orgUnit) {
            ...
            $scope.registerEntity = function (destination) {
                ...
                if( !$scope.selectedTei.trackedEntityInstance && $scope.selectedCountryName == null )
                {
                    var dialogOptions = {
                        headerText: 'registration_error',
                ...
                else if( !$scope.selectedTei.trackedEntityInstance && $scope.selectedDistrictName == null )
                {
                    var dialogOptions = {
                        headerText: 'registration_error',
                ...
                else if( !$scope.selectedTei.trackedEntityInstance && $scope.selectedCommunityName == null )
                {
                    var dialogOptions = {
                        headerText: 'registration_error',
