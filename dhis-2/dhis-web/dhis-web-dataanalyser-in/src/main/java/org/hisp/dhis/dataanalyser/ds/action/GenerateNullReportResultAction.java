...
public class GenerateNullReportResultAction implements Action
{
    ...
    public String execute() throws Exception
    {
        ...
        for( DataElement dataElement : dataElementList )
        {
            List<CategoryOptionCombo> decocList = new ArrayList<CategoryOptionCombo>(dataElement.getCategoryCombo().getOptionCombos() );
            String deAndOptionCombo = "";
            for( CategoryOptionCombo deCom  : decocList )
            {
