...
public class GenerateDataStatusDataSetWiseResultAction implements Action
{
    ...
    */
    ...
    public String execute() throws Exception
    {
        ...
        Constant constant = constantService.getConstant( constantMap.get( SUMMARYSTATUSVARIABLE ) );
        ...
        */
        ...
        while( dsIterator.hasNext() )
        {
            ...
            while ( orgUnitListIterator.hasNext() )
            {
                ...
                if ( maxOULevel < organisationUnitService.getOrganisationUnitLevel( orgUnit.getId() ).getLevel() )
                    maxOULevel = organisationUnitService.getOrganisationUnitLevel( orgUnit.getId() ).getLevel();
    
                if ( minOULevel > organisationUnitService.getOrganisationUnitLevel( orgUnit.getId() ).getLevel() )
                    minOULevel = organisationUnitService.getOrganisationUnitLevel( orgUnit.getId() ).getLevel();
