 ...
 */
public class GenerateKayakalpReportAnalyserResultAction
    implements Action
{
    ...
    */
        ...
        throws Exception
    {
         ...
         * inputTemplatePath ) ); WritableWorkbook outputReportWorkbook =
         * Workbook.createWorkbook( new File( outputReportPath ),
         * templateWorkbook );
         */
        ...
        while ( it.hasNext() )
        {
            ...
            while ( reportDesignIterator.hasNext() )
            {
                ...
                else
                {
                    if ( sType.equalsIgnoreCase( "dataelement" ) )
                    {
                        if ( aggData.equalsIgnoreCase( USECAPTUREDDATA ) )
                        {
                            ...
                            if ( deCodeString.equalsIgnoreCase( "[1.1]" ) || deCodeString.equalsIgnoreCase( "[2.1]" )
                                || deCodeString.equalsIgnoreCase( "[153.1]" )
                                || deCodeString.equalsIgnoreCase( "[155.1]" )
                                || deCodeString.equalsIgnoreCase( "[157.1]" )
                                || deCodeString.equalsIgnoreCase( "[158.1]" )
                                || deCodeString.equalsIgnoreCase( "[160.1]" ) )
                            {
                                // System.out.println(
                                // " USECAPTUREDDATA Before Converting : SType : "
                                // + sType + " DECode : " + deCodeString +
                                // "   TempStr : " + tempStr );
                                ...
                                // System.out.println(
                                // " USECAPTUREDDATA After Converting : SType : "
                                // + sType + " DECode : " + deCodeString +
                                // "   TempStr : " + tempStr );
                            }
                        ...
                        else if ( aggData.equalsIgnoreCase( GENERATEAGGDATA ) )
                        {
                            ...
                            {
                                // System.out.println(
                                // " GENERATEAGGDATA Before Converting : SType : "
                                // + sType + " DECode : " + deCodeString +
                                // "   TempStr : " + tempStr );
                                ...
                                // System.out.println(
                                // " GENERATEAGGDATA After Converting : SType : "
                                // + sType + " DECode : " + deCodeString +
                                // "   TempStr : " + tempStr );
                            }
                        ...
                        else if ( aggData.equalsIgnoreCase( USEEXISTINGAGGDATA ) )
                        {
                            ...
                            {
                                // System.out.println(
                                // " USEEXISTINGAGGDATA Before Converting : SType : "
                                // + sType + " DECode : " + deCodeString +
                                // "   TempStr : " + tempStr );
                                ...
                                // System.out.println(
                                // "  USEEXISTINGAGGDATA After Converting : SType : "
                                // + sType + " DECode : " + deCodeString +
                                // "   TempStr : " + tempStr );
                            }
                        }
                    ...
                    else
                    {
                        if ( aggData.equalsIgnoreCase( USECAPTUREDDATA ) )
                        {
                            tempStr = reportService.getIndividualResultIndicatorValue( deCodeString,
                                tempStartDate.getTime(), tempEndDate.getTime(), currentOrgUnit );
                        }
                        else if ( aggData.equalsIgnoreCase( GENERATEAGGDATA ) )
                        {
                ...
                // System.out.println( aggData + " 2 SType : " + sType +
                // " DECode : " + deCodeString + "   TempStr : " + tempStr + " "
                // + tempRowNo + " " + tempColNo + " " + sheetNo );
                ...
                else
                {
                    ...
                    /*
                     * WritableCell cell = sheet0.getWritableCell( tempColNo,
                     * tempRowNo );
                     * 
                     * CellFormat cellFormat = cell.getCellFormat();
                     * WritableCellFormat wCellformat = new
                     * WritableCellFormat(); wCellformat.setBorder( Border.ALL,
                     * BorderLineStyle.THIN ); wCellformat.setWrap( true );
                     * wCellformat.setAlignment( Alignment.CENTRE );
                     * 
                     * if ( cell.getType() == CellType.LABEL ) { Label l =
                     * (Label) cell; l.setString( tempStr ); l.setCellFormat(
                     * cellFormat ); } else { try { sheet0.addCell( new Number(
                     * tempColNo, tempRowNo, Double.parseDouble( tempStr ),
                     * wCellformat ) ); } catch( Exception e ) { sheet0.addCell(
