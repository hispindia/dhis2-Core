...
public class ScheduleSMSAction implements Action
{
    ...
    */
    ...
    public void scheduledNonReportingFacilitySMS() throws IOException
    {
        ...
        {
            List<OrganisationUnit> nonReportingFacilitys = new ArrayList<OrganisationUnit>( getNonReportingFacilityList( (int)dataSet.getId() ));
            ...
            {
                List<String> userMobileNoWithNameList = new ArrayList<String>( getUserMobileNoWithName( (int)nonReportingFaclity.getId() ));
    ...
    public List<String> getAllUsersMobileNumber()
    {
        ...
        */
        ...
        //Constant smsUserGroupConstant = constantService.getConstantByName( SMS_USER_GROUP_ID );
        Constant smsUserGroupConstant = constantService.getConstant( constantMap.get( SMS_USER_GROUP_ID ) );
    ...
    public List<DataElement> getDataElements()
    {
        ...
        //Constant adverseEventDataElementGroupConstant = constantService.getConstantByName( ADVERSE_EVENT_DATAELEMENT_GROUP_ID );
        Constant adverseEventDataElementGroupConstant = constantService.getConstant( constantMap.get( ADVERSE_EVENT_DATAELEMENT_GROUP_ID ) );
    ...
    public Map<String, String> getDataValueMap()
    {
        ...
        //Constant adverseEventDataElementGroupConstant = constantService.getConstantByName( ADVERSE_EVENT_DATAELEMENT_GROUP_ID );
        Constant indicatorDeGroupConstant = constantService.getConstant( constantMap.get( ADVERSE_EVENT_DATAELEMENT_GROUP_ID ) );
...
// Methods for Key Performance Indicators
    ...
    public List<OrganisationUnit> getOrganisationUnitsForKeyPerformanceIndicator()
    {
        ...
        Constant indicatorGroupConstant = constantService.getConstant( constantMap.get( WEBSERVICE_INDICATOR_DATAELEMENT_GROUP_ID ) );
    ...
    public List<Indicator> getIndicators()
    {
        ...
        Constant indicatorGroupConstant = constantService.getConstant( constantMap.get( WEBSERVICES_INDICATOR_GROUP_ID ) );
        int deGroupId = (int) indicatorGroupConstant.getValue();
    ...
    public Map<String, String> getIndicatorValueMap()
    {
        ...
        //Constant indicatorDeGroupConstant = constantService.getConstantByName( WEBSERVICE_INDICATOR_DATAELEMENT_GROUP_ID );
        Constant indicatorDeGroupConstant = constantService.getConstant( constantMap.get( WEBSERVICE_INDICATOR_DATAELEMENT_GROUP_ID ) );
        int deGroupId = (int) indicatorDeGroupConstant.getValue();
