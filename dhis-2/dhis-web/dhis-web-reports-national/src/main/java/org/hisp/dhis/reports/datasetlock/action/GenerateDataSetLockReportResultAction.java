    ...
    implements Action
{
        ...
        throws Exception
    {
        ...
        if ( ouIDTB != null )
        {
            ...
            //generateDataSetLockReport( organisationUnitService.getOrganisationUnit( ouIDTB.intValue() ), rowStart,colStart + organisationUnitService.getLevelOfOrganisationUnit( ouIDTB.intValue() ) );
        ...
        throws Exception
    {
        ...
        int currentLevel = organisationUnitService.getOrganisationUnitLevel( organisationUnit.getUid() ).getLevel();
        ...
        if ( organisationUnit.hasChild() )
        {
            ...
            for ( OrganisationUnit orgElement : organisationUnitChildren )
            {
                ...
                x++;
                //unlockedOrganisationUnitDatasetPeriods = generateDataSetLockReport( orgElement, x, organisationUnitService.getLevelOfOrganisationUnit( orgElement.getId() ) );
            ...
            if ( dSetSource.contains( organisationUnit ) )
            {
                ...
                for ( Period periodElement : periods )
                {
                    ...
                    boolean lockStatus = dataSetService.isLocked( null,dataSet, periodElement, organisationUnit, null, null );
