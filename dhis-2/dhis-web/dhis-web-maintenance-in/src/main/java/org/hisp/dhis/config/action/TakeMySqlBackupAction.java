    ...
    implements Action
{
    ...
    */
    ...
    {        
        ...
        String mySqlPath = configurationService_IN.getConfigurationByKey( Configuration_IN.KEY_MYSQLPATH ).getValue();
        ...
        backupFilePath = configurationService_IN.getConfigurationByKey( Configuration_IN.KEY_BACKUPDATAPATH ).getValue();
