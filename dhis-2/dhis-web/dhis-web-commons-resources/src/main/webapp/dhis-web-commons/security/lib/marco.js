...
<div class="col-xs-12 list-item">\
    ...
    <div class="col-xs-12 col-sm-8 list-content">\
        ...
        <h4 class="title"></h4>\
<p><a id="createAccountLink" style="color: white" target="_blank" href="lib/controllers/feedback.html?ouid='+ouid+'">Rate this Facility</a></p>\
    </div>\
    <div class="col-xs-12 list-main">\
        ...
        <a href="#" class="btn btn-default btn-blue-border" id="createAccountLink" target="_blank" href="lib/controllers/procedures.html?ouid='+ouid+'&ownership='+ownership+'"> Procedure LIst</a>\
    </div>\
    <div class="col-xs-12 col-sm-6 col-lg-3">\
        <a href="#" class="btn btn-default btn-blue-border" id="createAccountLink" target="_blank" href="lib/controllers/doctors.html?ouid='+ouid+'">Doctors List</a>\
    </div>\
...
//             <td width="20%"><p> <a id="createAccountLink" target="_blank" href="lib/controllers/procedures.html?ouid='+ouid+'&ownership='+ownership+'">Procedure List</a></p></td>\
