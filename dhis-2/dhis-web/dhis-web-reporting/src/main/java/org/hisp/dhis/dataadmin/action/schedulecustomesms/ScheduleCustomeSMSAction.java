...
public class ScheduleCustomeSMSAction implements Action
{
    ...
    public String execute() throws Exception
    {
        ...
        {
            mobileNumbers = new ArrayList<String>( getTrackedEntityInstanceAttributeValueByAttributeIdAndTrackedEntityInstanceIds( MOBILE_NUMBER_ATTRIBUTE_ID, trackedEntityInstanceIds ) );
        }
