            ...
            while ( rs.next() )
            {
                ...
                if ( teiID != null && orgUnitID != null && dueDate != null && mobileNo != null && mobileNo.length() == 10 )
                {
                    ...
                    if ( todayDate.equalsIgnoreCase( oneDayBeforeDateString ) )
                    {
                        ...
                        */
                        String customMessage = teiName + " " + ", 25 सेक्टर की डिस्पेंसरी में हाइ बीपी, शुगर, स्ट्रोक और कैंसर प्रोग्राम में जाँच के दौरान आप  में पाई गयी बीमारी की नियमित जाँच के लिए आप को दिनांक " + dueDate + 
                    ...
                    if ( teiID != null && orgUnitID != null && dueDate != null && mobileNo != null && mobileNo.length() == 10 )
                    {
                        ...
                        if ( todayDate.equalsIgnoreCase( oneDayBeforeDateString ) )
                        {
                            ...
                            */
                            ...
                            String customMessage = teiName + " " + ", सूचित किया जाता है कि प्रेग्नेन्सी दौरान देखभाल हेतु नियमित जाँच के लिए आपको   डिस्पेंसरी में दिनांक  " + dueDate + " " +
                    ...
                    if ( teiID != null && orgUnitID != null && dueDate != null && mobileNo != null && mobileNo.length() == 10 )
                    {
                        ...
                        if ( todayDate.equalsIgnoreCase( oneDayBeforeDateString ) )
                        {
                            ...
                            */
                            ...
                            String customMessage = teiName + " " + " ,आपकी डेलिवरी के बाद की देखभाल हेतु दिनांक   " + dueDate + " को डिस्पेंसरी की आशा या ए एन एम " +
                ...
                while ( rs.next() )
                {
                    ...
                    if ( teiID != null && orgUnitID != null && dueDate != null && mobileNo != null && mobileNo.length() == 10 )
                    {
                        ...
                        if ( todayDate.equalsIgnoreCase( oneDayBeforeDateString ) )
                        {
                            ...
                            */
                            String customMessage = teiName + " " + " , कृपा अपने बच्चे को दिनांक   " + dueDate + " वाले दिन डिस्पेंसरी में  ला कर उस का टीकाकरण करवाएँ| " + 
